...
// new editor-style Source specimen shows the owner's real file, not
// placeholder copy. Keys are raw (the component adds JSON quotes);
// values are JSON-ish strings (arrays joined, so no content hides
// behind a "[N items]" stub) and the component infers string/bool/
// number coloring from the value shape.
